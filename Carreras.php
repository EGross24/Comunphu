...
<head>
    ...
    <title>Añadir Carrera - Administración COMUNPHU</title>
    <style>
        h1 {
...
<body>
    ...
    <section id="contenedorPrincipaladd">
        <form id="formreg" action="PHP/guardarcarrera.php" method="POST">
            <div class="form-addasignatura">
                <label for="carrera">Nombre de la Carrera</label>
                <input type="text" name="nombrecarrera" id="nombrecarrera" required placeholder="&#x1F393    ej: Licenciatura en Derecho">
                <label for="escuela">Escuela</label>
                <select name="escuela" id="escuela" required>
                    <option value="escuela" disabled selected>Seleccione una Escuela</option>
                    <?php
