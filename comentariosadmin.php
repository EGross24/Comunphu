...
$sql = "SELECT id_comentario, docente_id, comentario, fecha FROM comentarios ORDER BY fecha DESC";
$resultado = mysqli_query($conexion, $sql);


// Manejar errores en la consulta
if (!$resultado) {
    die("Error al obtener los comentarios: " . mysqli_error($conexion));
}
?>
...
<body>
    ...
    <h1>Revisión de Comentarios</h1><br>
            ...
            <tbody>
                <?php while ($comentario = mysqli_fetch_assoc($resultado)) { ?>
                    <tr>
                        ...
                        <td><?php echo $comentario['docente_id']; ?></td>
